...
def run_daemon(watchdog_time: int, unix_socket_path: Optional[str], tcp_socket: Optional[tuple[str, int]]) -> None:
    ...
    responder = postfix.SocketmapResponder(asyncio_loop, unix_socket_path=unix_socket_path, tcp_socket=tcp_socket)
...
def main() -> None:
    parser = configargparse.ArgumentParser(description='Postfix Spam Email Blocker',
